...
@section('main-content')
    ...
    <div class="row">
        ...
        <div class="col-lg-8 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('trips.update', $trip) }}" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <select id="st_location" onchange="firstLocation()" class="form-control" name="st_location" value="{{ $trip->st_location }}" >
                                            @foreach($roads as $road)
                                                @if($road->name == $trip->st_location)
                                                    <option value="{{$road->name}}" selected>{{$road->name}}</option>
                                                @else
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <select id="end_location" onchange="secondLocation()" class="form-control" name="end_location" value="{{ $trip->end_location }}" >
                                            @foreach($roads as $road)
                                                @if($road->name == $trip->end_location)
                                                    <option value="{{$road->name}}" selected>{{$road->name}}</option>
                                                @else
                                                    <option value="{{$road->name}}" >{{$road->name}}</option>
                                                @endif
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="empty_seats" class="form-control" name="empty_seats" value="{{ $trip->empty_seats}}">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label" for="empty_seats">Price<span class="small text-danger">*</span></label>
                                        <input type="text" id="price" class="form-control" name="price" value="{{ $trip->price}}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <select id="st_time" class="form-control">
    ...
    <script>
        ...
        function getOldTimeValues(){
            var hours = {!! json_encode($hours) !!};
            $.each(hours, function( index, hour ) {
                inptNum++;
               hourArr = hour.st_time.split(":");
                $("#timeInputs").append("                <div id=\"time"+inptNum+"\" class=\"row\">\n" +
                    "                                        <div class=\"col-lg-6\">\n" +
                    "                                            <input name=\"times[]\" style=\"margin-bottom: 10px;\" type=\"text\" class=\"form-control\" value=\""+ hourArr[0] + ":" + hourArr[1] +"\">\n" +
                    "                                        </div>\n" +
                    "                                        <div class=\"col-lg-2\">\n" +
                    "                                            <button value=\""+ inptNum +"\" class=\"form-control btn btn-outline-danger\" type='button' onclick=\"deleteNewTime(this)\"><i class=\"fas fa-trash\"></i></button>\n" +
                    "                                        </div>\n" +
