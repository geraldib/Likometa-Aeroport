        ...
        <div class="col-lg-8 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{$user->name}} {{$user->surname}} Account</h6>
                </div>
                    ...
                    <form method="POST" action="{{ route('users.update', $user) }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="surname" class="form-control" name="surname" placeholder="Last name" value="{{ old('surname', $user->surname) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="number" class="form-control" name="number" placeholder="06########" value="{{ old('number', $user->number) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="current_password">Fjalkalimi i Vjeter</label>
                                        <input type="password" id="current_password" class="form-control" name="current_password" placeholder="Current password">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="new_password">Fjalkalimi i Ri</label>
