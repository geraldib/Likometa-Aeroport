                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('office.bookings') }}">
                ...
                <div style="margin-bottom: 100px" class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="booking-form">
                            ...
                            <form action="{{ route('office.bookings.store') }}" method="POST" >
                                ...
                                <div class="form-2">
                                    <div class="form-group">
                                        ...
                                        <input name="fname" type="text" class="form-control" id="fname" value="{{ old('fname') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="lname">Mbiemer</label>
                                        <input name="lname" type="text" class="form-control" id="lname" value="{{ old('lname') }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="celNr" type="text" class="form-control" id="celNr" value="{{ old('celNr') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="persNr">Numri i Personave</label>
                                        {{--                                <input name="persNr" type="text" class="form-control" id="persNr">--}}
                                    ...
                                    <div class="card" style="margin-bottom: 20px">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input style="display: none;" name="price" type="text" class="form-control" id="price" value="{{ old('price') }}">
                                            </div>
...
<script>
    ...
    function getIntersections(startlocVal) {
        ...
        $.ajax({
            type:'POST',
            url:'/office/get/city/intersections',
            async: false,
            data: {
                "_token": "{{ csrf_token() }}",
                "name"  : startlocVal,
