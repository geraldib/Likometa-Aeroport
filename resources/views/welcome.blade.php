                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            @else
                                <ul class="navbar-nav ml-auto">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('login') }}">Hyr</a>
                                    </li>
                                    ...
                                    <form action="{{ route('outside.store') }}" method="POST" >
                                        ...
                                        <div class="form-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="celNr" type="text" class="form-control" id="celNr">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="form-3" style="margin-bottom: 20px">
                                            ...
                                            <div class="card" style="margin-bottom: 20px">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @if($errors->has('price'))
                                                        <small style="color: #ff0000">{{ $errors->first('price') }}</small>
                                                    @endif
