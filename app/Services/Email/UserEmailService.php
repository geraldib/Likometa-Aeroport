...
class UserEmailService
{
    ...
    public function sendUserConfirmationMailService($booking, $members)
    {
        ...
        Mail::send('emails.bookings.user_confirm', $data, function($message) use ($to_email) {
            $message->to($to_email)
    ...
    public function sendConfirmationMailService($booking)
    {
        ...
        Mail::send('emails.bookings.office_confirm', $data, function($message) use ($to_email) {
            $message->to($to_email)
                ->subject('Konfirmo Rezervimin');
            $message->from('ilovemangass@gmail.com','Likometa Aeroprt');
        });
